...
public class RayTracingFirst {
    ...
    // ------------------------------------------------------------------------------------
    //  Scene Setup: Large spheres only
    // ------------------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------------------
    //  Ray Color (no shadows on the floor)
    // ------------------------------------------------------------------------------------
    private static Vec3 rayColor(Ray r, Hittable world, int depth, Random rng) {
        ...
        if (world.hit(r, 0.001, Double.POSITIVE_INFINITY, rec)) {
            // Check if the hit object is the ground sphere
            if (rec.mat instanceof Lambertian && rec.p.y < -999) {
                // Return the ground's albedo directly (no shadows)
                return ((Lambertian) rec.mat).albedo;
            }

            // Normal ray tracing for other objects
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Write to file
        File outFile = new File("output0.png");
